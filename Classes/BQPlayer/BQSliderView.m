...
- (void)configUI {
    ...
    _bgLayer = [self configLayerWithColor:[UIColor colorWithWhite:1 alpha:0.3]];
    _bufferLayer = [self configLayerWithColor:[UIColor colorWithWhite:1 alpha:0.5]];
    _bufferLayer.width = 0;
    _sliderLayer = [self configLayerWithColor:[UIColor whiteColor]];
    _sliderLayer.width = 0;
    ...
    UIImage * img = self.centerImg ?: [NSBundle playerBundleWithImgName:@"slider"];
    imgV.image = img;
