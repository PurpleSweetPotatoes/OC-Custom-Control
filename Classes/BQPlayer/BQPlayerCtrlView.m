...
- (void)sliderValueChange:(BQSliderView *)slider {
    if ([self.delegate respondsToSelector:@selector(ctrlViewSliderDidChange:)]) {
        [self.delegate ctrlViewSliderDidChange:slider];
    }
}
...
- (void)configUI {
    ...
    BQSliderView * sliderView = [[BQSliderView alloc] initWithFrame:CGRectMake(10, 0, self.width - 50, 40)];
    ...
    [fullBtn setImage:[NSBundle playerBundleWithImgName:@"fullscreen"] forState:UIControlStateNormal];
    [fullBtn setImage:[NSBundle playerBundleWithImgName:@"shrinkscreen"] forState:UIControlStateSelected];
...
- (UIView *)topToolView {
    if (_topToolView == nil) {
        ...
        UIImage * image = [NSBundle playerBundleWithImgName:@"top_shadow"];
...
- (UIButton *)centerBtn {
    if (_centerBtn == nil) {
        ...
        [btn setImage:[NSBundle playerBundleWithImgName:@"play_44x44_"] forState:UIControlStateNormal];
        [btn setImage:[NSBundle playerBundleWithImgName:@"pause_44x44_"] forState:UIControlStateSelected];
...
- (UIView *)bottomToolView {
    if (_bottomToolView == nil) {
        ...
        UIImage * image = [NSBundle playerBundleWithImgName:@"bottom_shadow"];
