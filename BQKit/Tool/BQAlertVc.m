...
- (void)setUpUI {
    ...
    if (self.customView) {
        ...
        titleLab.textColor = [UIColor colorFromHexString:@"282520"];
        ...
        contentLab.textColor = [UIColor colorFromHexString:@"282520"];
...
- (void)addBtnWithTitle:(NSString *)title type:(AlertBtnType)type handle:(_Nullable VoidAlertBlock)handle {
    ...
    [btn setTitleColor:[UIColor colorFromHexString:type == 0 ? @"1a237e":@"8e0000"] forState:UIControlStateNormal];
...
- (UIView *)disPlayerView {
    if (_disPlayerView == nil) {
        ...
        view.backgroundColor = [UIColor colorFromHexString:@"fcfcfc"];
